...
bool RenderSettings::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
void RenderSettings::ClearScene(float red, float green, float blue, float alpha)
{
